...
const nadmin = (app, options = {} ) =>{
    ...
    //registration route
    app.use(["/register", "/signup"], helmetCSP, i18n.init, register)     
    //session routes
    app.use(["/login" , "/signin"], loginRateLimiter.prevent, helmetCSP, i18n.init, sessionManager)
    app.use(["/logout", "/signout"], helmetCSP, i18n.init, sessionManager.destroy)
    //account recovery routes
    app.use("/forgotpassword", helmetCSP, i18n.init, reset)
    app.use('/recovery', helmetCSP, i18n.init, recovery)
    // - USER AUTH ROUTES
